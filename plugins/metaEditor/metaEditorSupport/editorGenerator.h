...
private:
	...
	void createGroup(QDomElement &parent, qReal::Id const &id);
	...
	void setGroupNodes(QDomElement &parent, qReal::Id const &id);
	...
	void setDividability(QDomElement &parent, qReal::Id const &id);
