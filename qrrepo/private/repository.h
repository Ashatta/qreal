...
{
public:
	Repository(const QString &workingFile, qReal::migration::Logger *logger, bool compressSaves);
	virtual ~Repository();
	...
	void saveDiagramsById(const QHash<QString, qReal::IdList> &diagramIds);
...
private:
	...
	QList<qReal::migration::Migration> mMigrations;
