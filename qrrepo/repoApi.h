...
public:
	...
	void save(const qReal::IdList &list) override;
	void saveTo(const QString &workingFile) override;
	void saveDiagramsById(const QHash<QString, qReal::IdList> &diagramIds) override;
	...
	void setMigrations(const QList<qReal::migration::Migration> &migrations) override;
