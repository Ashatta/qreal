...
int InterpreterEditorManager::editorVersion(const Id &editor) const
{
...
qrRepo::RepoApi * InterpreterEditorManager::metamodel(const QString &editor) const
{
	foreach (qrRepo::RepoApi * const repo, mEditorRepoApi.values()) {
		foreach (Id const &edit, repo->elementsByType("MetamodelDiagram")) {
...
bool InterpreterEditorManager::canMigrateMetamodels(QSet<QString> &canMigrate
...
bool InterpreterEditorManager::checkMigrationPossibility(QSet<QString> &canMigrate
...
bool InterpreterEditorManager::needMigrate(const qrRepo::CommonRepoApi &api, const Id &id) const
{
